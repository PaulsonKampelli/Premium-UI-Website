...
const Sidebar = ({ slides, current, onNav, isOpen }) => {
    ...
    <>
      ...
      {isOpen && (
        <div 
          ...
          onClick={() => onNav(current)} // Just close on click
        />
      )}
      ...
      <div className={`fixed left-0 top-0 h-screen w-[260px] md:w-[200px] bg-[#050505] border-r border-white/5 z-[100] flex flex-col py-12 transition-transform duration-500 ease-in-out ${
        ...
        <div className="flex-grow overflow-y-auto overflow-x-hidden px-4 space-y-8 custom-scrollbar">
