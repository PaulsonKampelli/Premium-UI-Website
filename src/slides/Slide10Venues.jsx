...
const Slide10Venues = ({ isActive, onInquire }) => {
  return (
    <SlideWrapper isActive={isActive}>
      ...
      <h2 className="headline-lg font-display text-white mb-16">Every Event Has Its Stage</h2>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 flex-grow h-full max-h-[600px]">
        <motion.div
        ...
        >
          ...
          <div className="p-10 flex flex-col flex-grow">
            ...
            <h3 className="font-display text-3xl text-white mb-6">Performing Arts Center</h3>
            ...
            <ul className="space-y-3 mb-8 flex-grow text-[13px]">
        ...
        >
          ...
          <div className="p-10 flex flex-col flex-grow">
            ...
            <h3 className="font-display text-3xl text-white mb-6">Exposition Center</h3>
            <p className="text-gray-text mb-6 text-sm leading-relaxed">
