...
const Slide10Venues = ({ isActive, onInquire }) => {
  return (
    <SlideWrapper isActive={isActive}>
      ...
      <h2 className="headline-lg font-display text-white mb-8 md:mb-6">Every Event Has Its Stage</h2>

      <div className="flex md:grid md:grid-cols-2 gap-6 md:gap-6 flex-grow md:max-h-[600px] overflow-x-auto pb-4 snap-x custom-scrollbar w-full">
        <motion.div
